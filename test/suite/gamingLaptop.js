...
describe('Daraz Mobile Android ', function () {
    ...
    it('Should Search The Gaming Laptop in The App', async function () {
        this.timeout(300 * 4000);
            ...
            filter.click();
            await new Promise(res => setTimeout(res, 3000));
            const gamingLaptop = await driver.elementByXPath("//android.widget.TextView[@text='Gaming Laptops']");
