...
describe('Daraz Mobile Android ', function () {
    ...
    it('Should Filter Basic Computer', async function () {
        this.timeout(300 * 3000);
            ...
            filter.click();
            await new Promise(res => setTimeout(res, 5000));
            const basicLaptop = await driver.elementByXPath("//android.widget.TextView[@text='Basic']");
            expect(basicLaptop).to.exist;
            basicLaptop.click();
            await new Promise(res => setTimeout(res, 3000));
