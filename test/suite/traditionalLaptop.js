...
describe('Daraz Mobile Android ', function () {
    ...
    it('Should Filter The Traditional laptop In The App', async function () {
        ...
        filter.click();
        await new Promise(res => setTimeout(res, 5000));
        const traditional = await driver.elementByXPath(" //android.widget.TextView[@text='Traditional Laptops']");
        expect(traditional).to.exist;
        traditional.click();
        await new Promise(res => setTimeout(res, 5000));
