...
describe('Daraz Mobile Android ', function () {
    ...
    it('Should Search The Lenovo Laptop in The App', async function () {
        ...
        filter.click();
        await new Promise(res => setTimeout(res, 5000));
        const lenovo = await driver.elementByXPath("//android.widget.TextView[@text='Lenovo']");
        expect(lenovo).to.exist;
        lenovo.click();
        await new Promise(res => setTimeout(res, 3000));
